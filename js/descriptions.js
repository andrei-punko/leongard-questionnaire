/** Описания акцентуаций по методичке (порядок шкал опросника 1–10) */
const ACCENTUATION_DESCRIPTIONS = [
  {
    scaleId: 1,
    name: 'Гипертимность',
    brief:
      'Повышенный фон настроения в сочетании с жаждой деятельности, высокой активностью, предприимчивостью.',
    description:
  ...
  },
  {
    ...
    brief:
      'Умеренная общительность, занудство, склонность к нравоучениям, настороженность и недоверчивость.',
    description:
  ...
  },
  {
    ...
    name: 'Эмотивность',
    brief:
      'Чувствительность, впечатлительность, глубина переживаний в области тонких эмоций в духовной жизни.',
    description:
  ...
  },
  {
    scaleId: 4,
    name: 'Педантичность',
    brief: 'Ригидность, инертность, долгое переживание травмирующих событий.',
    description:
  ...
  },
  {
    ...
    name: 'Тревожность',
    brief:
      'Высокий уровень тревожности, склонность к страхам, повышенная робость и пугливость.',
    description:
  ...
  },
  {
    ...
    name: 'Дистимность',
    brief:
      'Сниженный фон настроения, фиксация на мрачных сторонах жизни, идеомоторная заторможенность.',
    description:
  ...
  },
  {
    ...
    brief:
      'Большой диапазон эмоциональных состояний, склонность легко приходить в восторг от одних событий и в полное отчаяние от других.',
    description:
